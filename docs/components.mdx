...
- `contentStyle`: Define o tipo de estilazação do contéudo. Existem três tipos: _tool-tip_, _good-to-know_ e _warning_;
...
Este componente foi criado no intuíto de definir, de forma enfática, alguns pontos que podem ser interessantes serem
...
Sempre que houver algum trecho de código/ texto que se repete muito (mais de duas vezes), é interessante e considerado
...
<EmphasisText 
  ...
  description="
    ...
    no mundo React. Ou seja, é muito comum ver componentes dentro de outros componentes, aumentando sua legilibilidade
    e manutenção, contudo, no Docussauros esta feature é limitada.
  " 
/>